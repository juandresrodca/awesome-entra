...
- [EntraHuntKit](https://github.com/juandresrodca/EntraHuntKit) - SecLists, but for M365 defenders - paste-ready, ATT&CK-mapped KQL threat-hunting queries + IOC lists for Entra ID, Intune & Microsoft 365 (Defender XDR & Sentinel). [![stars](https://badgen.net/github/stars/juandresrodca/EntraHuntKit)](https://badgen.net/github/stars/juandresrodca/EntraHuntKit)
