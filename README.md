...
- [IntuneGraph](https://github.com/juandresrodca/IntuneGraph) - Turn your Microsoft Intune tenant into an interactive relationship graph. See what applies to a device or user and why, preview the blast radius before you touch a group, and find orphaned or broken assignments. [![stars](https://badgen.net/github/stars/juandresrodca/IntuneGraph)](https://badgen.net/github/stars/juandresrodca/IntuneGraph)
